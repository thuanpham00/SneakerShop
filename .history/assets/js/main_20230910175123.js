...
window.addEventListener("load", function () {
    ...
    // modal
    function createModal(nameProduct, image, price, priceTotal) {
...
<div class="modal__priceProduct">
                                ...
                                <div class="modal__priceProduct-row">
                                    ...
                                    <span class="price priceTotal">${priceTotal}</span>
                                </div>
                            </div>
                    </div>
                </div>
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            const priceTotal = parseInt(amountProduct.textContent)
            // xử lý total
            createModal(nameProductModal, imageModal2, priceRcm,priceTotal);
