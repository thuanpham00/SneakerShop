...
window.addEventListener("load", function () {
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            const sizeUS = document.querySelectorAll(".modal-tableSize__size.sizeUS");
            [...sizeUS].forEach(item => item.addEventListener("click", function(e) {
                const textSize = item.textContent;
                const size = item.parentNode.parentNode.parentNode.previousElementSibling;
