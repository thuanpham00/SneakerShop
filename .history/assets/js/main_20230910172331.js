...
window.addEventListener("load", function () {
    ...
    // modal
    function createModal(nameProduct, image, price, amount) {
...
<div class="modal__priceProduct">
                                ...
                                <div class="modal__priceProduct-row">
                                    ...
                                    <span class="price priceTotal">$1910</span>
                                </div>
                            </div>
                    </div>
                </div>
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            const amountProduct = document.q
            createModal(nameProductModal, imageModal2, priceRcm, amount);
