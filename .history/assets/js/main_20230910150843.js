...
window.addEventListener("load", function () {
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            // table size
            const tableSize = document.querySelector(".modal-tableSize sizeUS");
            const modalTableSize = document.querySelector(
                ".modal-tableSize__size"
            );
            console.log(modalTableSize.textContent);
