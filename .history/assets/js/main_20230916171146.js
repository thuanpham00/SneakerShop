...
<div class="modal__priceProduct">
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            const addCart1 = document.querySelector(
                ".addCart.mobileHeaderCart-2"
            );
            const iconCart1 = document.querySelector(
                ".header-buy__body.cart-2.mobileHeaderCart-2"
            );
            iconCart1.addEventListener("click", function (e) {
                addCart1.classList.toggle("visible");
            });
            addCart1.addEventListener("click", function (e) {
                popup.classList.add("visible");
                popup.classList.remove("hidden");
                const upCard = parseInt(numberCart.textContent) + 1;
                numberCart.textContent = upCard;
