window.addEventListener("load", function () {
    ...
    buttonContinue.addEventListener("click", function(e) {
        ...
        // console.log(formBig)
        // formBig.classList
        const hihii = formSign.parentNode.nextElementSibling;
        const hehee = formLogin.parentNode.nextElementSibling.nextElementSibling
        console.log(hihii)
        console.log(hehee)
        hihii.classList.remove("big-2")
        hehee.classList.remove("big-2")
    })
});
