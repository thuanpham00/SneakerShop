...
window.addEventListener("load", function () {
    ...
    // xử lý icon passWord
    const iconPassword = document.querySelector(".form-control.form-4");
    iconPassword.addEventListener("click", function(e) {
        iconPassword.classList.toggle(".fa.fa-eye.toggle")
        iconPassword.classList.toggle(".fa-regular.fa-eye-slash")
        console.log("kaa")
    })
