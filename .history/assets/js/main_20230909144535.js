...
//     const template2 = `<section class="adver">
//     <div class="adver__thumb-1">
//         <img src="./assets/img/home/qcao/1.jpg" alt="" class="adver__image">
//     </div>
//     <div class="adver__thumb-2">
//         <img src="./assets/img/home/qcao/2.jpg" alt="" class="adver__image">
//     </div>
// </section>`;
//     document.body.insertAdjacentHTML("beforeend", template2);
// }
const banner_adver = document.querySelector(".banner");
const bannerHeight = banner_adver && banner_adver.offsetHeight;
const banner__header = bannerHeight + 100; // 460
const adver1 = document.querySelector(".adver__thumb-1");
const adver2 = document.querySelector(".adver__thumb-1");
console.log(adver1);
console.log(banner__header);
window.addEventListener(
    "scroll",
    debounceFn(function (e) {
        const pageY = window.pageYOffset;
        console.log(pageY);
        if (pageY > banner__header) {
            adver1.classList.add("visible");
            adver2.classList.add("visible");
        }
        if (pageY == 0) {
            adver1.classList.remove("visible");
            adver2.classList.remove("visible");
        }
    }, 100)
);
