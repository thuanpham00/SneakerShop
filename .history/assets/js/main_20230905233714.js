...
//     "scroll",
//     debounceFn(function () {
//         const pageY = window.pageYOffset; // 100
//         if (pageY > headerHeight) {
//             header.classList.add("is-sticky");
//         } else {
//             header.classList.remove("is-sticky");
//         }
//         headerSearch_input.classList.toggle("input__width");
//         headerSearch_iconX.classList.toggle("icon__width")
//     }, 100)
// );
...
const headerSearch_iconX = document.querySelector(".header__iconX")
