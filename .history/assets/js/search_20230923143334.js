...
window.addEventListener("load", function () {
    ...
    todoList.addEventListener("click", function(e) {
        if(e.target.matches(".todo-list__remove")) {
            ...
            const text = itemText.querySelector(".todo-list__title").textContent;
            const find = todos.findIndex(item => item === text); // dò tìm trong localStorage có cái nào giống text thì remove đi
        }
    })
});
