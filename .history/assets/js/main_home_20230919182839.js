    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            addToCard.addEventListener("click", function (e) {
                ...
                // const addCartItem = document.querySelectorAll(".addCart__item");
                // const addCartItemHTML = [];

                // [...addCartItem].forEach((item) => {
                //     addCartItemHTML.push(item.outerHTML);
                // });
                // /*
                // Thuộc tính outerHTML là một thuộc tính chỉ đọc của các phần tử trong DOM. 
                // Nó trả về một chuỗi HTML đại diện cho phần tử đó cùng với tất cả các phần tử con và nội dung bên trong.
                // */
                // localStorage.setItem(
                //     "addCartItem",
                //     JSON.stringify(addCartItemHTML)
                // );
                // window.addEventListener("DOMContentLoaded", function (e) {
                //     const storeAddCartItemHTML =
                //         localStorage.getItem("addCartItem");
                //     console.log(storeAddCartItemHTML)
                //     const storeAddCartItem = JSON.parse(storeAddCartItemHTML);

                //     if (storeAddCartItem) {
                //         const cartList =
                //             document.querySelector(".addCart__list");
                //         cartList.innerHTML = storeAddCartItem.join("");
                //     }
                // });
            });
        })
