...
window.addEventListener("load", function () {
    ...
    // modal
    function createModal(nameProduct, image) {
        const templateModal = `<div class="modal">
        <div class="container">
            <div class="modal__body">
                <figure class="modal__left">
                    <h3 class="modal__heading">
                        Nike SB Dunk Low Nike SB Dunk Low Nike SB Dunk
                        Low
                    </h3>
                    <img
                        src="./assets/img/home/sneaker-2/1.jpg"
                        alt=""
                        class="modal__img"
                    />
                </figure>
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            const imageModal = e.target.querySelector(".recommend__pic");
