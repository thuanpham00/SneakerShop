...
// call api
const endPoint = "http://localhost:912/product";
// thêm dữ liệu từ json
// async function addNewCourse({ image, title, price }) {
//     const response = await fetch(endPoint, {
//         method: "POST", // thêm dữ liệu vào database
//         body: JSON.stringify({
//             // chuyển đổi đối tượng thành 1 chuỗi json
//             image,
//             title,
//             price,
//         }),
...
//     });
// }
const sneakerList = document.querySelector(".sneaker__list");
...
async function getProduct(link = endPoint) {
    const response = await fetch(endPoint)
