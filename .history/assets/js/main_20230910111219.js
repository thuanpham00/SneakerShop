...
window.addEventListener("load", function () {
    ...
    const numberModal = document.querySelector(".modal-quantity__counterNumber")
    const buttonModalLeft = document.querySelector(".modal-quantity__counterLeft");
    buttonModalLeft.addEventListener("click", function(e) {
        const textNumber = numberModal.textContent;
