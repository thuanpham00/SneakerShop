...
// call api
const endPointSneaker = "http://localhost:912/productSneaker";
const endPointShoes = "http://localhost:912/productShoes";
const sneakerList = document.querySelector(".sneaker-list");
const shoesList = document.querySelector(".sneaker-list.shoes-list");
...
function renderItemShoes(item) {
    const template2 = `<div class="sneaker__item">
    <a href="#!" class="sneaker__link"
        ><img
            src="${item.image}"
            alt="Sneaker"
    ...
    shoesList.insertAdjacentHTML("beforeend", template2);
}

// lấy dữ liệu từ json sneaker và get ra giao diện
async function getProductSneaker(link = endPointSneaker) {
