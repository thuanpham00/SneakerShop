        ...
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            document.body.addEventListener("click", function (e) {
                if (e.target.matches(".modal-quantity__counterLeft")) {
                    ...
                    // xử lý total
                    // const totalModal = total.textContent * textMinus
                    // console.log(totalModal)
                    // total.textContent = totalModal
                ...
                const total = document.querySelector(".priceProduct").textContent;
            ...
            // function createPop_up() {
            //     const templatePopup = `<div class="pop-up">
            ...
            //         <span>Success!</span>
            //         <p class="desc">
            //             You have successfully added the product to your cart and
            //             proceed to checkout
            //         </p>
            //         <button class="btn">
            //             <a href="#!">Continue </a>
            ...
            //     </div>
            // </div>`
            // document.body.insertAdjacentHTML("beforeend", templatePopup)
            // }
            const popup = document.querySelector(".pop-up")
            addoCard.addEventListener("click", function(e) {
