...
<div class="modal__priceProduct">
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            function createItemCart(title) {
                const templateCart = `<div class="addCart__item">
                <img src="./assets/img/home/sneaker-2/11.jpg" alt="" class="addCart__img">
                <div class="addCart__info">
                    <h4 class="addCart__name">
                        Jordan 1
                    </h4>
                    <div class="addCart__amount">
                        <span class="addCart__Number">1</span>
    ...
    const addCart = this.document.querySelector(".addCart") 
    const iconCart = document.querySelector(".header-buy__icon.icon-2");
