...
window.addEventListener("load", function () {
                            ...
                            <div class="modal-tableSize">
                                ...
                                <div class="modal-tableSize__list row row-cols-lg-3">
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 4</span>
                                        <span class="modal-tableSize__price">$1,327</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 4.5</span>
                                        <span class="modal-tableSize__price">$600</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 5</span>
                                        <span class="modal-tableSize__price">$354</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 5.5</span>
                                        <span class="modal-tableSize__price">$458</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 6</span>
                                        <span class="modal-tableSize__price">$258</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 6.5</span>
                                        <span class="modal-tableSize__price">$277</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 7</span>
                                        <span class="modal-tableSize__price">$304</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 7.5</span>
                                        <span class="modal-tableSize__price">$327</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 8</span>
                                        <span class="modal-tableSize__price">$325</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 8.5</span>
                                        <span class="modal-tableSize__price">$328</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 9</span>
                                        <span class="modal-tableSize__price">$340</span>
                                    </div>
                                    <div class="modal-tableSize__item">
                                        <span class="modal-tableSize__size">US M 9.5</span>
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) { // item
            ...
            const priceRcm = item.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.textContent;
            const priceModal = document.querySelector(".modal-buy__link");
            priceModal.textContent = priceRcm;

            createModal(nameProductModal, imageModal2, price);
            ...
            modalInfoAll.addEventListener("click", function(e) {
                // const tableSize = e.target.nextElementSibling;
