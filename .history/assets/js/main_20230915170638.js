...
<div class="modal__priceProduct">
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            //     savedHTMLs.push(templateCart);
            //     localStorage.setItem(
            //         "savedHTMLs",
            //         JSON.stringify(savedHTMLs.map((html) => html.toString()))
            //     );
            //     console.log(localStorage.getItem("savedHTMLs"));
            // }
            ...
            //     const savedHTMLs = JSON.parse(
            //         localStorage.getItem("savedHTMLs")
            //     );

            //     if (savedHTMLs === null) {
            //         console.log("Dữ liệu không được lưu trữ.");
            //     } else {
            //         console.log("Dữ liệu được lưu trữ thành công:");
            //         savedHTMLs.forEach((html) => console.log(html));
            //     }
            // });
            const cartList = document.querySelector(".addCart__list");
            const addToCard = document.querySelector(".cart");
            function createItemCart(image, nameCart, amountCart) {
                ...
                cartList.prepend(document.createTextNode(templateCart));
