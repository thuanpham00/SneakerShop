    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            addToCard.addEventListener("click", function (e) {
                ...
                // tong = tong + parseInt([...moneyCart].forEach(item.textContent));
                // const sum = [...moneyCart].forEach(
                //     (item) =>  (tong = tong + parseInt(item.textContent))
                // );
                console.log([...moneyCart].forEach(
                    (item) =>  (tong = tong + parseInt(item.textContent))
                ))
                // console.log(moneyCart.textContent)
