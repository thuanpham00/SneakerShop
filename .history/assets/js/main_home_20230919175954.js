    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            addToCard.addEventListener("click", function (e) {
                ...
                /*
                Thuộc tính outerHTML là một thuộc tính chỉ đọc của các phần tử trong DOM. Nó trả về một chuỗi HTML đại diện cho phần tử đó cùng với tất cả các phần tử con và nội dung bên trong.
                */
