window.addEventListener("load", function () {
    ...
    async function addNewCourse({ firstName, lastName, email, pass }) {
    ...
    formBody.addEventListener("submit", async function(e) {
        ...
        const infoLogin = {
            ...
            lastName: this.elements["firstName"].value;
            email: this.elements["firstName"].value;
            pass: this.elements["firstName"].value;
        }
    })
});
