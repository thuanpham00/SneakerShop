...
sneakerList1.addEventListener("click", function (e) {
    if (e.target.matches(".sneaker__item")) {
        const sneakerItem = e.target.parentNode.parentNode;
        console.log(sneakerItem)
        // xử lý hình
        // const imageModal = e.target.querySelectorAll(".sneaker__pic");
        // [...imageModal].forEach((item) => {
        //     const imageModal2 = item.getAttribute("src");
