...
<div class="modal__priceProduct">
    ...
    [...rcmImg].forEach((item) =>
        item.parentNode.parentNode.addEventListener("click", function (e) {
            ...
            const itemPrice = document.querySelector(".moneyCart.Cart-1");
            const itemPrice2 = itemPrice.textContent
            ...
            addToCard.addEventListener("click", function (e) {
                ...
                // xử priceAddCart
                const priceAddCart = document.querySelector(".priceTotal").textContent
                const number = itemPrice2.reduce(function(previousValue, currentValue) {
                ...
                // let arr = [];
                // [...item].forEach(item => arr.push(item))
                // console.log(arr)
