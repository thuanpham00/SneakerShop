...
<div class="modal__priceProduct">
    ...
    const hoursText = document.querySelector(".days");
    const minutesText = document.querySelector(".days");
    ...
    function countDownTimer(date) {
        ...
        function countDown() {
            ...
            if (timer > 0) {
                ...
                hoursText.textContent = `0${days}`.slice(-2)
                minutesText.textContent = `0${days}`.slice(-2)
                secondsText.textContent = `0${days}`.slice(-2)
            } else {
                return;
            }
        }
